...
namespace ECommerceWebsite.Areas.Admin.Controllers
{
    public class NewsController : Controller
    {
        ...
        {
            IQueryable<News> news = db.News.OrderBy(n => n.CreatedDate);
            ...
            if (!string.IsNullOrWhiteSpace(search))
            {
                news = news.Where(n => n.Title.Contains(search) || n.Text.Contains(search) || n.ShortDescription.Contains(search)).OrderBy(n => n.CreatedDate);
            }
